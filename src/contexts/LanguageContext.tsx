...
const translations: Record<Language, Record<string, string>> = {
  sk: {
    ...
    "testimonials.1.content":
      "Výborná služba! Vodoinštalatér prišiel promptne a rýchlo vyriešil problém s mojím umývadlom. Profesionálny, zdvorilý a veľmi zručný. Vrelo odporúčam!",
    "testimonials.2.name": "Jana Horváthová",
    "testimonials.2.role": "Majiteľka bytu",
    "testimonials.2.content":
      "Fantastická skúsenosť! Tím bol veľmi profesionálny a cena bola férová. Opravili mi celú kúpeľňu za jeden deň. Určite ich budem kontaktovať znova.",
    "testimonials.3.name": "Peter Novák",
    "testimonials.3.role": "Správca budovy",
    "testimonials.3.content":
      "Spoľahlivá firma s rozumnými cenami. Pomohli nám s výmenou všetkých potrubí v celej budove. Práca bola dokončená v termíne a v rozpočte.",
  ...
  en: {
    ...
    "seo.description":
      "Professional plumber in Bratislava. Fast pipe repairs, sanitary installation, drain cleaning and 24/7 emergency service. Call 0944 562 059.",
    "seo.keywords":
      "plumber bratislava, water repair, emergency plumber, drain cleaning, sanitary installation, good plumber",
    ...
    "hero.description":
      "Professional installation and repair of plumbing systems. We solve all plumbing problems quickly and reliably.",
    ...
    "services.description":
      "Professional installation and repair of plumbing systems with emphasis on quality and customer satisfaction.",
    ...
    "services.pricing.description":
      "The exact amount depends on the type of work and condition of the equipment. Contact me by phone or message for an exact price.",
    ...
    "testimonials.description":
      "Stories of successful projects and satisfied customers who trusted us with their plumbing needs.",
    "testimonials.1.name": "Martin Kovac",
    "testimonials.1.role": "Homeowner",
    "testimonials.1.content":
      "Excellent service! The plumber arrived promptly and quickly solved the problem with my sink. Professional, polite and very skilled. Highly recommend!",
    "testimonials.2.name": "Jana Horvathova",
    "testimonials.2.role": "Apartment Owner",
    "testimonials.2.content":
      "Fantastic experience! The team was very professional and the price was fair. They fixed my entire bathroom in one day. Will definitely contact them again.",
    "testimonials.3.name": "Peter Novak",
    "testimonials.3.role": "Building Manager",
    "testimonials.3.content":
      "Reliable company with reasonable prices. They helped us replace all the pipes in the entire building. Work was completed on time and on budget.",
    ...
    "faq.1.answer":
      "For regular orders, we arrive within 24-48 hours. In urgent situations, we provide emergency service with arrival within 60 minutes.",
    "faq.2.question": "What services do you offer?",
    "faq.2.answer":
      "We offer comprehensive plumbing services including water pipe repairs, sanitary equipment installation, drain cleaning, heating repairs and boiler installation.",
    "faq.3.question": "Do you provide warranties on your work?",
    "faq.3.answer":
      "Yes, we provide a minimum 24-month warranty on all our work. For some types of work, we also offer an extended warranty.",
    "faq.4.question": "How much does your service cost?",
    "faq.4.answer":
      "Prices depend on the type of work. We always provide a free quote before starting work so you know exactly what to expect. No hidden fees.",
    "faq.5.question": "Do you work on weekends?",
    "faq.5.answer":
      "Yes, we provide services 7 days a week. For emergency services, we are available 24/7 including holidays.",

    // Footer
    "footer.description":
      "Good Plumber - with you 24/7. Professional plumbing services for your home. Fast and reliable.",
    ...
    "siphon.seo.description":
      "Professional siphon replacement for kitchen, bathroom and WC. We fix leaking, bad smell and clogged siphons. Fast service in Bratislava.",
    "siphon.seo.keywords":
      "siphon replacement, siphon repair, siphon installation, sink siphon, bathtub siphon, leaking siphon, plumber bratislava",
    ...
    "wc.seo.description":
      "Fast repair of leaking WC, flush replacement and new toilet installation in Bratislava. Geberit service. Call now.",
    ...
    "faucet.seo.description":
      "Professional installation and replacement of faucets. Repair of dripping taps in kitchen and bathroom.",
    ...
    "pipe.seo.description":
      "Emergency water pipe repair. Localization and elimination of water leaks. Fast service in Bratislava.",
    ...
    "shower.seo.description":
      "Professional installation of shower cabins, trays and screens. Silicone sealing. Quality work.",
    "shower.seo.keywords":
      "shower cabin installation, shower installation, shower tray replacement, shower sealing, plumber bratislava",
    ...
    "appliance.seo.description":
      "Professional connection of washing machines, dishwashers and dryers. Water supply and drain adjustment.",
    "appliance.seo.keywords":
      "washing machine connection, dishwasher installation, appliance installation, water connection, plumber bratislava",
    ...
    "valve.seo.description":
      "Replacement of non-functional and old corner valves under sink, by WC or washing machine. Prevent flooding.",
    ...
    "sanitary.seo.description":
      "Complete sanitary installation for bathroom and kitchen. Sink, bathtub, bidet and kitchen sink installation.",
    "sanitary.seo.keywords":
      "sanitary installation, sink installation, bathtub installation, kitchen sink, bathroom renovation",
    ...
    "heating.seo.description":
      "Installation, replacement and repair of radiators. Fixing leaking valves and system venting. Heating work.",
    "heating.seo.keywords":
      "radiator replacement, heating repair, leaking radiator, radiator installation, heating bratislava",
    ...
    "boiler.seo.description":
      "Professional electric boiler replacement. Water and electric connection, commissioning. Old boiler removal.",
    "boiler.seo.keywords":
      "boiler replacement, boiler installation, electric boiler, water heater connection, boiler service",
    ...
    "pipes.seo.description":
      "Complete replacement of water and drainage pipes in apartments and houses. Riser and installation renovation.",
