...
export default function Page() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(makeServiceSchema("Zapojenie spotrebičov", data.title, data.description)) }} />
      <ServiceLayout translationKey="appliance" image={serviceImages.appliance} />
    </>
  );
}
