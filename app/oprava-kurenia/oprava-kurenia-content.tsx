...
import { Phone, CheckCircle, MapPin, Clock, Shield, Zap, Star, Wrench, ArrowRight, Thermometer, Home, Building, AlertTriangle, ChevronDown, Flame, Droplets } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">
                Potrebujete <span className="text-primary-light">kúrenára</span>?
              </h2>
