...
export default function Page() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(makeServiceSchema("Montáž batérie", data.title, data.description)) }} />
      <ServiceLayout translationKey="faucet" image={serviceImages.faucet} />
    </>
  );
}
