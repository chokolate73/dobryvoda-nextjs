...
export default function Page() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(makeServiceSchema("Montáž sprchy", data.title, data.description)) }} />
      <ServiceLayout translationKey="shower" image={serviceImages.shower} />
    </>
  );
}
